...
async def onb_done(callback: CallbackQuery) -> None:
    ...
    text = (
        ...
        f"• {settings.btn_consultant} или /guide — пошаговая помощь по работе.\n"
        "• /tokens — ваши лимиты.\n"
...
async def _send_main_welcome(message: Message | None, settings) -> None:
    ...
    text = (
        ...
        f"• {settings.btn_trial} — пробный период.\n"
        f"• {settings.btn_plans} — выбор линии модели и пакета токенов.\n"
        f"• {settings.btn_consultant} или /guide — пошаговая помощь.\n"
        "• /tokens — ваши лимиты.\n"
...
async def cmd_help(message: Message) -> None:
    ...
    await message.answer(
        ...
        "/help — эта справка\n"
        "/guide (или /consult) — подробная инструкция и автосоздание консультанта\n"
        "/cancel — отмена текущего мастера/опроса\n"
        ...
        f"Кнопки: «{settings.btn_trial}», «{settings.btn_plans}», «{settings.btn_consultant}», "
        f"«{settings.btn_agent_settings}»."
    )
